...
class MyDocument extends Document {
  ...
  render() {
    return (
      ...
      <meta name="apple-mobile-web-app-title" content="Art Of Talk" />
      ...
      <link rel="icon" href="/artoftalk.svg" />
      <script async src="https://www.googletagmanager.com/gtag/js?id=G-F4WF9L7FTE"></script>

  ...
  function HeaderSEO() {
    return (
      <Head>
        ...
        <meta
          property="og:image"
          content={`${process.env.NEXT_PUBLIC_DOMAIN_URL}/artoftalk.jpg`}
        />
        <meta
    ...
    <>
      ...
      <Layout>
        ...
        <div className="div-container mt-5">
          <section className={styles.title3}> TRENDING ON Art of Talk</section>
          <div className="row col">
            <TrendingList />
          </div>
        </div>
                  ...
                  <div className="row col justify-content-center">
                    <div className="col-md-5 col-sm-5 col-lg-5 col-6 p-2">
                      <img
                        ...
                        alt="travlojournal"
                        onClick={() =>
                          (window.location = "http://travlojournal.com")
                        }
                    ...
                    <div className="col-md-5 col-sm-5 col-lg-5 col-6 p-2">
                      <img
                        ...
                        alt="artoftalk"
                        onClick={() =>
                          (window.location = "http://artoftalk.in")
                        }
                        className={styles.logo}
                      />
                    </div>
                    <div className="col-md-5 col-sm-5 col-lg-5 col-6 p-2">
                      <img
                        ...
                        alt="elitegamezone"
                        onClick={() =>
                          (window.location = "http://elitegamezone.com")
                        }
                        className={styles.logo}
                      />
                    </div>
                    ...
                    <div className="col-md-5 col-sm-5 col-lg-5 col-6 p-2">
                      <img
                        ...
                        alt="geeksocean"
                        onClick={() =>
                          (window.location = "http://geeksocean.com")
                        }
                        className={styles.logo}
                      />
                    </div>
